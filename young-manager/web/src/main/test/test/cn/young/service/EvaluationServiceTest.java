...
//            System.out.println(evaluationMapper.getEvaluationByCourse_code("AC15202").getRate_three()); //23
            ...
            evaluation.setCourse_code("XXXXX");
            evaluation.setTotal(16);
            evaluation.setAverage_mark(3.43);
            evaluation.setRate_three(12);
//            evaluationMapper.insert(evaluation);
            evaluationMapper.updateByCourse_code(evaluation);
