...
<body>
        ...
        <fieldset class="layui-elem-field">
            ...
            <legend >
                <p style="font-size: 23px;">
                    <i class="layui-icon layui-icon-read layui-pull-center" style="font-size: 30px;"></i> 合作院校</p>
            </legend>
            <br>
    ...
    <div class="layui-container layui-pull-center" style="margin-bottom: 30px;width: 1240px;">
        ...
        <fieldset class="layui-elem-field ">
            ...
            <legend>
                <p style="font-size: 23px;">
                    <i class="layui-icon layui-icon-read layui-pull-center" style="font-size: 30px;"></i>&nbsp;东南大学</p><br>
            </legend>
    ...
    <div class="layui-container layui-pull-center" style="margin-bottom: 30px;width: 1240px;">
        ...
        <fieldset class="layui-elem-field ">
            ...
            <legend>
                <p style="font-size: 23px;">
                    <i class="layui-icon layui-icon-read layui-pull-center" style="font-size: 30px;"></i> 中国科学技术大学</p><br>
            </legend>
