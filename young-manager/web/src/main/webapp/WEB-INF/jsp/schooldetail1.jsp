...
<div class="page_wrap">
    <div class="page_min">
        <ul>
            <form class="" method="post" action="/coursePre">

                <button class="layui-btn layui-btn-primary layui-btn-sm"><i class="layui-icon"></i></button>
            </form>

            <li class=""><a  href="http://localhost:8080/schooldetail1?page=1&limit=20">1</a></li>
            <li class=""><a  href="http://localhost:8080/schooldetail1?page=2&limit=20">2</a></li>
            <li class=""><a  href="http://localhost:8080/schooldetail1?page=3&limit=20">3</a></li>
            <li class=""><a  href="http://localhost:8080/schooldetail1?page=4&limit=20">4</a></li>
            <li class=""><a  href="http://localhost:8080/schooldetail1?page=5&limit=20">5</a></li>
            <li class=""><a  href="http://localhost:8080/schooldetail1?page=6&limit=20">6</a></li>
            <form class="" method="post" action="/courseNext">
            ...
            <%--<li style="margin-right: 10px;"><a href="/courseNext" class="next">下一页</a></li>--%>
